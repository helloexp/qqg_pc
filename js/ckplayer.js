		...
		*/
        ...
        interFace: function() {
			...
			*/
            ...
            html += '<div style="height:0px;" class="definitionchgaiibyyyyz"  data-title="点击选择清晰度" style="line-height: 38px; color: rgb(255, 255, 255); float: left; font-size: 14px; text-align: center; overflow: hidden; display: block; cursor: pointer; width: 200px;"><span style="line-height:33px;font-size:15px;letter-spacing:2px;color:#ffffff;;padding-left:5px;">直播中 '+ nowTime +'</span></div>';
            html += '<div class="' + timeTextID + '" style="display: none;">' + timeInto + '</div>'; //时间文本
            ...
            // html += '<div class="timeprogressbgchsxgualpdre" style="width: 100%; height: 1px; background-color: rgb(63, 63, 63); overflow: hidden; position: absolute; bottom: 100px; z-index: 88; display: block;"><div class="loadprogresschsxgualpdre" style="width: 14px; height: 6px; position: absolute; bottom: 100px; top: 0px; z-index: 91; background-color: rgb(111, 111, 111);"></div><div class="timeprogresschsxgualpdre" style="width: 327px; height: 6px; position: absolute; bottom: 100px; top: 0px; z-index: 91; background-color: rgba(7,130,245,0.03);"></div></div>';

            html += '<div class="controlPage" style="width: 100%;position: absolute;z-index: 5;margin-top:37px;border-top:1px solid #8b8b8b;float:right;">\n' +
                '        <div class="view">\n' +
                '            <a href=""><span>收藏</span><i></i></a>\n' +
                '            <div class="watch"><span>观看: <span>686</span></span></div>\n' +
                '        </div>\n' +
                '        <div style="float:left">\n' +
                '            <div class="cPlay">\n' +
                '                <ul>\n' +
                '                    <li><a href=""><span>240P</span></a></li>\n' +
                '                    <li><a href=""><span>360P</span></a></li>\n' +
                '                    <li><a href=""><span>720P</span></a></li>\n' +
                '                </ul>\n' +
                '            </div>\n' +
                '        </div>\n' +
                '        <div class="pages">\n' +
            ...
            this.getByElement(timeBOBGID).innerHTML = '<div class="' + timeBOID + '" style="display: none;"><div class="' + timeBWID + '"></div></div>';
            //构建进度条内容结束
